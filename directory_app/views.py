...
class Main(LoginRequiredMixin, ListView):
    model = Organization
    template_name = 'Главная.html'
    context_object_name = 'org'


class Organizations(LoginRequiredMixin, DetailView):
    model = Organization
...
class UpdateWorker(LoginRequiredMixin, PermissionRequiredMixin, UpdateView):
    model = User
    template_name = 'update.html'
    context_object_name = 'worker'
    fields = ['name', 'post', 'address', 'communications', 'organization', 'password', 'role', 'is_superuser']
...
class Department(LoginRequiredMixin, ListView):
    model = User
